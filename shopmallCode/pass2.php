...
if ($pass != $passwd) {            // 암호가 일치하지 않는 경우
    ...
    switch ($mode) {
        case 0:          // 수정 프로그램 호출
            echo("<meta   http-equiv='Refresh' content='0; url=reviewmodify.php?id=$id&user=$UserID'>");
            break;
        case 1:          // 삭제 프로그램 호출
            echo("<meta   http-equiv='Refresh' content='0; url=reviewdelete.php?id=$id&user=$UserID'>");
            break;
    }   	   
}  
