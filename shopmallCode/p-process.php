...
$result = mysql_query("insert into product(class, code, name, content, price1, price2, userfile,fileexplain, hit, class2) values ($class, '$code', '$name', '$content', '$price1', '$price2', '$temp','$temp2', 0, $class2)", $con);
