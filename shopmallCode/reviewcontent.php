...
$result=mysql_query("select * from testboard where code='$pcode' and id=$id",$con);
...
echo("
	...
	<tr  height=50><td align=left ><a href='p-show.php?code=$code' style='text-decoration:none; border-radius:5px;'>목록</a></td>
	<td align=right><a href='pass.php?board=testboard&id=$id&mode=0&user=$UserID' style='text-decoration:none; border-radius:5px;'>수정</a>
	<a href='pass.php?board=testboard&id=$id&mode=1&user=$UserID' style='text-decoration:none;border-radius:5px;'>삭제</a>
