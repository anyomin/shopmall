...
echo ("
	...
	<table width=670 border=0 cellpadding=0 cellspacing=5 align=center style='margin-top:200px;'>
	...
	<table width=670  align=center border=0 cellpadding=0 cellspacing=5 style='margin-top:30px;'>
	<tr><td height=40 align=center><input type=submit value='회원정보수정' class='button'> </td></tr>
	</table>
	</form>
");
include ("bottom.html");
